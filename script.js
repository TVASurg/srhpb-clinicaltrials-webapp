...
function fillTrialDetails(mainCategory, key) {
  ...
  if(mainCategory[`additionalNotes`][key] != null)
    {
    notesString += '<li class="list-group-item bg-gray-200 text-gray-900 btn btn-toggle d-inline-flex align-items-center fw-semibold" data-bs-toggle="collapse" data-bs-target="#notesCollapse">Summary</li><li class="list-inline-item ps-5 collapse" id="notesCollapse"><p class="py-2">';
  ...
  //Arms
  armString += '<li class="list-group-item bg-gray-300 text-gray-900 btn btn-toggle d-inline-flex align-items-center fw-semibold" data-bs-toggle="collapse" data-bs-target="#armsCollapse">Arms/Cohorts</li><li class="list-inline-item ps-5 collapse" id="armsCollapse"><p class="py-2">';
  ...
  if(mainCategory[`NCT`][key] != null)
    {
  NCTstring += '<li class="list-group-item bg-gray-600 text-gray-900 btn btn-toggle d-inline-flex align-items-center fw-semibold" data-bs-toggle="collapse" data-bs-target="#nctCollapse">Helpful links</li><li class="list-inline-item ps-5 collapse" id="nctCollapse"><p class="py-2">';
