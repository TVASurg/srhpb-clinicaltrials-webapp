  ...
  fetch(`/jsonUpdates/latest.json?ver=${Date.now()}`)
    ...
    .then(data => { 
      ...
      //loop through each sheet and putting them into appropriate object/arrays
        ...
        //this is a semi-log that tracks changes
...
doc.autoTable({
  ...
  headStyles: { fillColor: [104, 119, 173], textColor: 255 },
  pagebreak: 'auto',
  rowPageBreak: 'avoid',
  columnStyles: {
  ...
  didParseCell: function (data) {
    if (data.section === 'body') {
      if (data.row.index % 2 === 0 && data.column.index > 0 ) {
        data.cell.styles.fillColor = [171, 195, 245];
  ...
  didDrawPage: function (data) {
    ...
    doc.setFontSize(15);
    doc.setFont("helvetica", "bold");
    doc.text("CRC", startX + cellWidth / 2 + 8, startY + (endY - startY) / 2, {
      angle: 90,
      align: 'center',
      baseline: 'middle'
    });
